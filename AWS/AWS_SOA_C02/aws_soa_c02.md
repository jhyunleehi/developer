...
SysOps 관리자가 Amazon EC2 Auto Scaling 그룹에서 새로운 Amazon EC2 Spot Instances를 프로비저닝하고 가용성이 높은 풀에서 인스턴스를 가져오도록 구성하려면 **C. 용량 최적화 전략을 사용하여 스팟 인스턴스를 시작합니다**를 선택하는 것이 가장 적합합니다.
